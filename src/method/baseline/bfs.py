...
BFS Baseline Method
===================
Single LLM call: hierarchy presented in BFS (breadth-first) order.
...
def process_bfs(i, text, dataset, prompt_type, cfg, call_gpt, use_desc, id2desc):
    """
    BFS method: present the hierarchy in breadth-first order and ask the LLM to pick a leaf.
    ...
    user_prompt = pm.bfs(id2label, layer2ids, id2info)
